...
type Form struct {
	...
	GoName                 string             `xml:"go-name,attr,omitempty"`
	MMXMode                string             `xml:"mmx-mode,attr,omitempty"`
	XMMMode                string             `xml:"xmm-mode,attr,omitempty"`
	CancellingInputs       bool               `xml:"cancelling-inputs,attr,omitempty"`
	NaCLVersion            string             `xml:"nacl-version,attr,omitempty"`
	NaCLZeroExtendsOutputs string             `xml:"nacl-zero-extends-outputs,attr,omitempty"`
	Operand                []*Operand         `xml:"Operand"`
	ImplicitOperand        []*ImplicitOperand `xml:"ImplicitOperand"`
...
type Operand struct {
	...
	Input        *bool  `xml:"input,attr,omitempty"`
	Output       *bool  `xml:"output,attr,omitempty"`
	ExtendedSize uint   `xml:"extended-size,attr,omitempty"`
}
...
type Encoding struct {
	VEX          *VEX          `xml:"VEX,omitempty" json:"VEX,omitempty"`
	EVEX         *EVEX         `xml:"EVEX,omitempty" json:"EVEX,omitempty"`
	Prefix       []*Prefix     `xml:"Prefix,omitempty" json:"Prefix,omitempty"`
	REX          *REX          `xml:"REX,omitempty" json:"REX,omitempty"`
	Opcode       []*Opcode     `xml:"Opcode,omitempty" json:"Opcode,omitempty"`
	ModRM        *ModRM        `xml:"ModRM,omitempty" json:"ModRM,omitempty"`
	CodeOffset   *CodeOffset   `xml:"CodeOffset,omitempty" json:"CodeOffset,omitempty"`
	DataOffset   *DataOffset   `xml:"DataOffset,omitempty" json:"DataOffset,omitempty"`
	Immediate    []*Immediate  `xml:"Immediate,omitempty" json:"Immediate,omitempty"`
	RegisterByte *RegisterByte `xml:"RegisterByte,omitempty" json:"RegisterByte,omitempty"`
}
...
type Opcode struct {
	...
	Addend string `xml:"addend,attr,omitempty"`
}

type Prefix struct {
	Byte      string `xml:"byte,attr,omitempty"`
	Mandatory string `xml:"mandatory,attr,omitempty"`
}
...
type VEX struct {
	...
	M5   string `xml:"m-mmmm,attr,omitempty"`
	PP   string `xml:"pp,attr,omitempty"`
	R    string `xml:"R,attr,omitempty"`
	B    string `xml:"B,attr,omitempty"`
	X    string `xml:"X,attr,omitempty"`
	V4   string `xml:"vvvv,attr,omitempty"`
}
...
//
type EVEX struct {
	M2      string `xml:"mm,attr,omitempty"`
	PP      string `xml:"pp,attr,omitempty"`
	LL      string `xml:"LL,attr,omitempty"`
	W       *uint  `xml:"W,attr"`
	V4      string `xml:"vvvv,attr,omitempty"`
	V       string `xml:"V,attr,omitempty"`
	RR      string `xml:"RR,attr,omitempty"`
	B       string `xml:"B,attr,omitempty"`
	X       string `xml:"X,attr,omitempty"`
	Bsmall  string `xml:"b,attr,omitempty"`
	A3      string `xml:"aaa,attr,omitempty"`
	Z       string `xml:"z,attr,omitempty"`
	Disp8xN string `xml:"disp8xN,attr,omitempty"`
}
